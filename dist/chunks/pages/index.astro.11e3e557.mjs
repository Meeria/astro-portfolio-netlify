/* empty css                                 */import { c as createAstro, a as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, b as addAttribute, u as unescapeHTML, d as renderComponent, F as Fragment, e as renderHead, f as renderSlot } from '../astro.ea77c928.mjs';
import { about, work, projects, education, certificates, contact, veille, name, designation, location } from './content.js.61e445fe.mjs';
...
}, "D:/BTS SIO 2/Dev/astro-vitae/node_modules/astro-icon/lib/Icon.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/node_modules/astro-icon/lib/Spritesheet.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/node_modules/astro-icon/lib/SpriteProvider.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/node_modules/astro-icon/lib/Sprite.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/src/layouts/BaseLayout.astro", void 0);
...
` })}`;
}, "D:/BTS SIO 2/Dev/astro-vitae/src/layouts/AccordionLayout.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/src/components/Card.astro", void 0);
...
const $$Container = createComponent(async ($$result, $$props, $$slots) => {
  ...
  ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "A propos", "icon": "mdi:account-badge-outline" }, { "default": ($$result2) => renderTemplate`${about}` })}
    ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "Exp\xE9riences professionnelles", "icon": "ic:baseline-work-outline" }, { "default": ($$result2) => renderTemplate`${work.map((item) => {
    ...
    ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "Projets", "icon": "ion:md-build" }, { "default": ($$result2) => renderTemplate`${projects.map((item) => {
    return renderTemplate`${renderComponent($$result2, "Card", $$Card, { "title": item.title, "timeframe": item.timeframe, "description": item.description, "tags": item.tech, "url": item.url, "url_name": "Voir plus" })}`;
  })}` })}

    ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "Parcours scolaire", "icon": "carbon:education" }, { "default": ($$result2) => renderTemplate`${education.map((item) => {
    ...
    return renderTemplate`${renderComponent($$result2, "Card", $$Card, { "title": item.title, "timeframe": item.issued, "description": item.org, "tags": item.description, "url": item.url, "url_name": "Voir certifications" })}`;
  })}` })}
    ...
    ${renderComponent($$result, "AccordionLayout", $$AccordionLayout, { "title": "Ma veille", "icon": "mdi:home" }, { "default": ($$result2) => renderTemplate`${veille.map((item) => {
    return renderTemplate`${renderComponent($$result2, "Card", $$Card, { "title": item.title, "timeframe": "", "description": item.description, "tags": "", "url": item.source, "url_name": item.source_name })}`;
  })}` })}
</ul>`;
}, "D:/BTS SIO 2/Dev/astro-vitae/src/components/Container.astro", void 0);
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  <article class="grid grid-cols-3 grid-rows-1 place-items-center w-[98vw] max-w-2xl">
    ...
    <div class="grid text-center self-center whitespace-nowrap" style="margin-left:5em;">
...
}, "D:/BTS SIO 2/Dev/astro-vitae/src/components/Header.astro", void 0);
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<footer class="bg-background/5 flex justify-between items-center px-2 py-1 astro-SZ7XMLTE">
    <p class="astro-SZ7XMLTE">© 2023 Mériadec DENIER D'APRIGNY</p>
</footer>`;
}, "D:/BTS SIO 2/Dev/astro-vitae/src/components/Footer.astro", void 0);
...
}, "D:/BTS SIO 2/Dev/astro-vitae/src/pages/index.astro", void 0);

const $$file = "D:/BTS SIO 2/Dev/astro-vitae/src/pages/index.astro";
const $$url = "";
